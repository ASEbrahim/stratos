...
const styles = StyleSheet.create({
  ...
  userBubble: { backgroundColor: colors.accent.primary + '25', borderTopRightRadius: borderRadius.sm },
  assistantBubble: { backgroundColor: colors.bg.tertiary, borderTopLeftRadius: borderRadius.sm, maxWidth: '90%' },
