...
document.addEventListener('DOMContentLoaded', () => {
    initChartFullscreen(); /* Works on desktop AND mobile */
...
/* Extract data points from a Lightweight Charts series via its data */
function _extractSeriesData(series) {
    if (!series) return [];
    /* Try the series' internal data first (ISeriesApi has no public getData in v4.2,
       but we can read from our stored marketData). */
...
/* Extract data for a markets-panel chart by entry */
